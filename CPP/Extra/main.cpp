...
void printPreorder(int start, int end,vector<int> const &postorder, int &pIndex,unordered_map<int, int> &map, stack<int> &stack)
{
    // base case
    if (start > end)
    {
...
int main()
{
    ...
    */
    ...
    vector<int> inorder = { 8,4,9,2,5,10,1,11,63,7};
    vector<int> postorder = {8,9,4,10,5,2,11,6,7,3,1 };
